  ...
  rules: {
    ...
    where_clause: ($) =>
      prec.right(
        seq(
          "where",
          optional(seq(sepBy1(",", $.where_predicate), optional(","))),
        ),
      ),
      ...
      seq(
        ...
        optional(
          seq(
            ...
            field(
              "value",
              choice($.block, $.identifier, $._literal, $.negative_literal),
            ),
          ),
        ),
      ),
    ...
    use_bounds: ($) =>
      seq(
        "use",
        token(prec(1, "<")),
        sepBy(",", choice($.lifetime, $._type_identifier)),
        optional(","),
        ">",
      ),
    ...
    _reserved_identifier: ($) =>
      alias(choice("default", "union", "gen", "raw"), $.identifier),
